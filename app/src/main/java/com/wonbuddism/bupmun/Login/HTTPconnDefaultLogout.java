...
public class HTTPconnDefaultLogout extends AsyncTask<Void,Void,Void> {
    ...
    public HTTPconnDefaultLogout(Activity activity) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if (responseCode == null) {
           // Toast.makeText(activity, "로그아웃 실패하였습니다", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(activity,"세션이 만료되어 로그아웃 되었습니다",Toast.LENGTH_SHORT).show();
