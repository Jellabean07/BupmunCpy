...
public class HTTPconnFeelingAll extends AsyncTask<Void,Void,Void>{
    ...
    public HTTPconnFeelingAll(Activity activity, FeelingRecycleViewAdapter adapter,
                              TextView totalCount, String page_no) {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if (responseCode == null) {
           ...
           // adapter.setFeelingMemos(feelingMemos);
    ...
    private FeelingMemo getFeelingMemo(JSONObject jInfo){
        ...
        try{
            ...
            REGIST_DATE = jInfo.getString("REGIST_DATE").substring(0,10);
        }catch (JSONException e){
            e.printStackTrace();
        }
