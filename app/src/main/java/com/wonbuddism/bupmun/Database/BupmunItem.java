 ...
 */
public class BupmunItem implements Serializable {
    private int NO;
    ...
    public BupmunItem(String BUPMUNINDEX, String TITLE1, String TITLE2,
    ...
    public BupmunItem(int NO, String BUPMUNINDEX, String TITLE1, String TITLE2,
