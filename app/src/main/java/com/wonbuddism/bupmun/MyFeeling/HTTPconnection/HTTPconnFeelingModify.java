...
public class HTTPconnFeelingModify extends AsyncTask<Void,Void,Void>{
    private Activity activity;
    private String TAG = "HTTPconnFeelingModify";
    private String http_conection_url = "http://115.91.201.9/memo/modify";
    ...
    public HTTPconnFeelingModify(Activity activity,String index, String memo_seq,String memo_contents) {
    ...
    protected Void doInBackground(Void... params) {
        String postData =  http_otp +"="+OTP + "&"+ http_index +"="+ INDEX + "&"+http_memo_seq+"="+MEMO_SEQ + "&"+http_memo_contents+"="+MEMO_CONTENTS;
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if (responseCode == null) {
            Toast.makeText(activity, "감각감상 수정에 실패하였습니다", Toast.LENGTH_SHORT).show();

        } else if (responseCode.contains("00")) {
            //  00 : 정상

            // resultdata; -> 성공여부
            Toast.makeText(activity,"감각감상이 수정 되었습니다",Toast.LENGTH_SHORT).show();
